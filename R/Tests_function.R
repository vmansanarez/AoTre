...
#' @description Function to compute the Cumulative frequency Curve of time
#'              series at a specific occurrence probability. In Hydrology, the
#'              cumulative frequency curve of a Discharge time serie is called
#'              "Flow Duration curve".
#' @param x a vector of real, value of the time series.
#' @param probs.FDC a real, between 0 and 1. Specific probability of occurrence
